...
namespace MalbersAnimations.HAP
{
    public class PullingHorses : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (RightHorse.ForwardMovement == 0)
            {
            ...
            else
            {
                ...
                PullingDirection = Vector3.Lerp(PullingDirection, transform.forward * RightHorse.Anim.velocity.magnitude * (RightHorse.ForwardMovement >= 0 ? 1 : -1), Time.deltaTime * 15);                   //Calculate the current speed of the animator root motion
