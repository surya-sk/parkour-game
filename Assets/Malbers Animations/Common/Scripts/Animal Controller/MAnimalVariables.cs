...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
        ...
        public Vector3 AdditivePosition//;
        {
            ...
            {
                additiveP = value;
              //  Debug.Log($"Additive Pos:  {(additiveP / DeltaTime):F3} ");
            }
        }
        Vector3 additiveP;
    ...
    /// <summary>Does it have a Hip Pivot?</summary>
        ...
        public Vector3 TargetSpeed
        {
            get
            {
                ...
                if (debugGizmos) Debug.DrawRay(base.transform.position, forward * SpeedModPos * ScaleFactor * DeltaTime, Color.cyan);
        ...
        private string m_StateFloat = "IDFloat";
        ...
        private string m_ModeStatus = "IDInt";
