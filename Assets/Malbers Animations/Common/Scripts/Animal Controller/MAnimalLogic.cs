...
namespace MalbersAnimations.Controller
{
    public partial class MAnimal
    {
        ...
        {
           PitchDirection = Vector3.Slerp( PitchDirection, Target_Direction, DeltaTime * CurrentSpeedModifier.lerpRotation * 2);
           if (debugGizmos) Debug.DrawRay(transform.position, this.PitchDirection * 2, Color.yellow);
        }
