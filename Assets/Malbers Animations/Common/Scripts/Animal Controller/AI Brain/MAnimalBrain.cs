...
namespace MalbersAnimations.Controller.AI
{
    ...
    public class MAnimalBrain : MonoBehaviour, IAnimatorListener
    {
        ...
        public void TaskDone(int TaskIndex, bool value = true) => TasksDone[TaskIndex] = value;
        ...
        public void ResetTaskTimeElapsed(int Index) => TasksTimeElapsed[Index] = 0;
        ...
        public void ResetDecisionTimeElapsed(int Index) => DecisionsTimeElapsed[Index] = 0;
