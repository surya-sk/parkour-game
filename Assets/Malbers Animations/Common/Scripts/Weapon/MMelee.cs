...
namespace MalbersAnimations.Weapons
{
    ...
    public class MMelee : MWeapon 
    {
        ...
        void AttackTriggerEnter(Collider other)
        {
            ...
            Direction = (Owner.position - other.bounds.center).normalized;              //Calculate the direction of the attack
        ...
        void OnDisable()
        {
            if (trigerProxy && meleeTrigger.isTrigger)
            {
