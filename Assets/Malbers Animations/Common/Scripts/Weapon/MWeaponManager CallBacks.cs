...
namespace MalbersAnimations.HAP
{
    ...
    public partial class MWeaponManager
    {
        ...
        {
            if (WeaponIsActive) Weapon.MainAttack_Start(this);
        }
        ...
        protected int StoreWeaponID => (WA.Store * 100 + (Weapon.HolsterAnim != null ? Weapon.HolsterAnim.ID : ActiveHolster));
        protected int DrawWeaponID => (WA.Draw * 100 + (Weapon.HolsterAnim != null ? Weapon.HolsterAnim.ID : ActiveHolster));
