...
namespace MalbersAnimations.HAP
{
    ...
    public partial class MWeaponManager
    {
        ...
        // private bool DefaultMonturaCamInput;                             //For storing the Montura Input Type
        ...
        /// <summary> Holsters Reference</summary>
       // public Holsters holsters;

       // public int ActiveHolsterID { get; set; }
        ...
        public BoolReference ToggleEquipping = new BoolReference(true);
        ...
        public string m_WeaponCharge = "ModePower";
      ...
      //  public TransformEvent OnTarget = new TransformEvent();
        ...
        public int WeaponAction
        {
            ...
            {
                weaponAction = value;
                if (debug) Debug.Log($"<B>{name}:<color=green> [Weapon Action] -> {value}</color></b> T{Time.time:F3}");
        ...
        private void SetWeapon(bool new_Weapon)
        {
            if (new_Weapon)
            {
                ...
                //if (Rider.Montura)  
                //    m_weapon.IgnoreTransform = Rider.Montura.transform;
