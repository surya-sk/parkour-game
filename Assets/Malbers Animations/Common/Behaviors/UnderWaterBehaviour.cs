...
namespace MalbersAnimations
{
    ...
    public class UnderWaterBehaviour : StateMachineBehaviour {
        ...
        override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            Vector3 forward = (transform.forward * animal.ForwardMovement) + (transform.up * Up);                 //Calculate the Direction to Move
           ...
           // DeltaRotation = transform.rotation;
            ...
            if (forward.magnitude > 0.001)
            {
                ...
                float smooth = Mathf.Max(Mathf.Abs(animal.MovementAxis.y), Mathf.Abs(animal.ForwardMovement));
