...
Shader "Malbers/Color3x3"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 temp_output_155_0 = ( ( ( _Color1 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g339 - 1.0 ) / temp_output_7_0_g339 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g339 / temp_output_7_0_g339 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g339 - 1.0 ) / temp_output_8_0_g339 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g339 / temp_output_8_0_g339 ) ) * 1.0 ) ) ) ) + ( _Color2 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g342 - 1.0 ) / temp_output_7_0_g342 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g342 / temp_output_7_0_g342 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g342 - 1.0 ) / temp_output_8_0_g342 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g342 / temp_output_8_0_g342 ) ) * 1.0 ) ) ) ) + ( _Color3 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g338 - 1.0 ) / temp_output_7_0_g338 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g338 / temp_output_7_0_g338 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g338 - 1.0 ) / temp_output_8_0_g338 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g338 / temp_output_8_0_g338 ) ) * 1.0 ) ) ) ) ) + ( ( _Color4 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g344 - 1.0 ) / temp_output_7_0_g344 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g344 / temp_output_7_0_g344 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g344 - 1.0 ) / temp_output_8_0_g344 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g344 / temp_output_8_0_g344 ) ) * 1.0 ) ) ) ) + ( _Color5 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g340 - 1.0 ) / temp_output_7_0_g340 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g340 / temp_output_7_0_g340 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g340 - 1.0 ) / temp_output_8_0_g340 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g340 / temp_output_8_0_g340 ) ) * 1.0 ) ) ) ) + ( _Color6 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g346 - 1.0 ) / temp_output_7_0_g346 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g346 / temp_output_7_0_g346 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g346 - 1.0 ) / temp_output_8_0_g346 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g346 / temp_output_8_0_g346 ) ) * 1.0 ) ) ) ) ) + ( ( _Color7 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g343 - 1.0 ) / temp_output_7_0_g343 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g343 / temp_output_7_0_g343 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g343 - 1.0 ) / temp_output_8_0_g343 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g343 / temp_output_8_0_g343 ) ) * 1.0 ) ) ) ) + ( _Color8 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g345 - 1.0 ) / temp_output_7_0_g345 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g345 / temp_output_7_0_g345 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g345 - 1.0 ) / temp_output_8_0_g345 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g345 / temp_output_8_0_g345 ) ) * 1.0 ) ) ) ) + ( _Color9 * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g341 - 1.0 ) / temp_output_7_0_g341 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g341 / temp_output_7_0_g341 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g341 - 1.0 ) / temp_output_8_0_g341 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g341 / temp_output_8_0_g341 ) ) * 1.0 ) ) ) ) ) );
...
/*ASEBEGIN
Version=18500
-1536;57;1536;842;1784.726;722.0018;3.07064;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;201;-43.05084,-721.7265;Float;False;Property;_GradientIntensity;Gradient Intensity;28;0;Create;True;0;0;False;0;False;0.75;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;268;792.0692,1258.979;Float;False;Property;_MRE1;MRE 1;16;0;Create;True;0;0;False;1;Header(Metallic(R) Rough(G) Emmission(B));False;0,1,0,0;0,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;207;585.6387,-538.9446;Float;False;Property;_GradientScale;Gradient Scale;30;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;285;1723.407,545.6401;Inherit;False;Property;_EmissionPower;Emission Power;25;0;Create;True;0;0;False;1;Header(Emmision);False;1;4.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;288;2668.074,508.8452;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;210;2457.192,-422.6459;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;289;1174.184,-360.0373;Inherit;True;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;259;2260.053,-98.53266;Inherit;True;Property;_DetailMap;DetailMap;27;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Gradient);False;-1;None;0f424a347039ef447a763d3d4b4782b0;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3810.323,174.2632;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Malbers/Color3x3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;0;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=978B0839AE38E5E7EA1604AFD69282F814CCAE32